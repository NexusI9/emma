...
void Widget::Frame::Component::draw() {
...
bool Widget::Frame::Component::clickbox_hovered() {
...
bool Widget::Frame::Component::boundbox_hovered() {
  return ImGui::IsMouseHoveringRect(
      ImVec2(vpx(node->world_position[0]), vpy(node->world_position[1])),
      ImVec2(vpx(node->end_point[0]), vpy(node->end_point[1])));
}

void Widget::Frame::Component::draw_fill(ImColor color, const float scale) {
...
void Widget::Frame::Component::draw_texture() {
...
void Widget::Frame::Component::draw_pod() {
