...
solution_module_update_epic_meaning(SolutionModule *solution) {
  ...
  solution->core.epic_meaning =
      compound_module_semantic_get_epic_meaning(&solution->compounds.semantic);
}
...
solution_module_update_empowerment(SolutionModule *solution) {
  ...
  solution->core.empowerment =
      w_semantic *
          compound_module_experience_get_empowerment(&solution->compounds.experience) +
      w_experience *
          compound_module_semantic_get_empowerment(&solution->compounds.semantic);
}

static inline void
solution_module_update_social_influence(SolutionModule *solution) {
  solution->core.social_influence =
      compound_module_social_get_influence(&solution->compounds.social);
}
...
static inline void solution_module_update_excitment(SolutionModule *solution) {
  ...
  solution->core.excitment =
      ...
      w_social * compound_module_social_get_excitement(&solution->compounds.social) +
      w_experience *
          compound_module_experience_get_excitement(&solution->compounds.experience,
...
solution_module_update_social_bounding(SolutionModule *solution) {
  ...
  solution->core.social_bounding =
      compound_module_social_get_bounding(&solution->compounds.social);
}

static inline void solution_module_update_friction(SolutionModule *solution) {

  solution->core.friction = compound_module_experience_get_friction(
