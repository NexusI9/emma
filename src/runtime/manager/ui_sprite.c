  ...
  static const TextureAtlasRegion region[UISprite_COUNT] =
      {
          ...
          [UISprite_Pod_Base] =
              {
                  .label = "Pod Base",
                  .uv0 = {scale * 0.0f / tex_res, scale * 178.0f / tex_res},
                  .uv1 = {scale * 160.0f / tex_res,
                          scale * (178.0f + 160.0f) / tex_res},
                  .size = {scale * 160.0f, scale * 160.0f},
              },
          [UISprite_Pod_Window] =
              {
                  .label = "Pod Windows",
                  .uv0 = {scale * 160.0f / tex_res, scale * 178.0f / tex_res},
                  .uv1 = {scale * 2 * 160.0f / tex_res,
                          scale * (178.0f + 160.0f) / tex_res},
                  .size = {scale * 160.0f, scale * 160.0f},
              },
